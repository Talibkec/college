            ...
            <div class="col-md-8">
                <div class="page-content"><h2>Faculty Members</h2>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt="" src="http://keck.ac.in/34/image${fileExtension}"
                                                                             style="background-image: url(dummy.png)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                ...
                                <div class="col-sm-3 box-profile-link"><a href="http://keck.ac.in/department/ash/vk"
                                                                          class="btn btn-default btn-lg"> <br
                                        class="hidden-xs"/> <i class="fa fa-link"></i> Visit<br class="hidden-xs"/>
                                    Profile Page </a></div>
                            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-3 box-profile-image"><img alt=""
                                                                                 src="http://keck.ac.in/36/image${fileExtension}"
                                    ...
                                    <div class="col-sm-3 box-profile-link"><a href="http://keck.ac.in/department/ash/snk"
                                                                              class="btn btn-default btn-lg"> <br
                                            class="hidden-xs"/> <i class="fa fa-link"></i> Visit<br class="hidden-xs"/>
                                        Profile Page </a></div>
                                </div>
