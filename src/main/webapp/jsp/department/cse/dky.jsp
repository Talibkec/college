        ...
        <div class="row">
            <aside class="col-sm-3" role="complementary">
                                    ...
                                    <section id="block-menu-block-3" class="block block-menu-block clearfix">
                                     ...
                                     <ul class="menu nav">
                                    <li class="first leaf  menu-mlid-1154"><a href="http://keck.ac.in/department/cse/subodh" class="sf-depth-2 active">Subodh Kumar</a></li>
                                    <li class="leaf menu-mlid-1121"><a href="http://keck.ac.in/department/cse/dky" class="sf-depth-2">Dharmveer Kumar Yadav</a></li>
                                    <li class="leaf menu-mlid-1156"><a href="http://keck.ac.in/department/cse/shweta" class="sf-depth-2">Shweta Kumari</a></li>
                                    <li class="leaf menu-mlid-1294"><a href="http://keck.ac.in/department/cse/snehakumari" class="sf-depth-2">Sneha Kumari</a></li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"  style="height: 200px;width:250px"
                        ...
                        <i class="fa fa-envelope"></i> <a href="mailto:${facultyPersonalEmail}"> <span>${facultyPersonalEmail}</span>
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>Ph.D. (Pursuing from BIT Mesra) </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="panel panel-default facultyInfo">
                            <div class="panel-heading"><Strong>Specializations</Strong></div>
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1.&nbsp&nbspArtificial Intelligence </td>
                                </tr>
                                <tr>
                                    <td>2.&nbsp&nbspCompiler Design</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1.&nbsp&nbspObject-Oriented Software Testing<br/>2.&nbsp&nbspTheory of Computation </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp 7 &nbsp;years of Teaching Experience</td>
                                </tr>
                                <tr>
                                    <td>&nbspWorked at NIT Jamshedpur(Asst. Prof. on contract) </td>
                                </tr>
                                <tr>
                                    <td>&nbspWorked in NBPDCL(BSPHCL) </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    <div class="panel panel-default facultyInfo">
                        ...
                        <table class="table table-striped">
                            <tbody>
                            <tr>
                                <td>&nbspSports & Cultural Section </td>
                            </tr>
                            </tbody>
                        </table>
                    </div></div>
