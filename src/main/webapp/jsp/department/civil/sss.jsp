        ...
        <div class="row">
            <aside class="col-sm-3" role="complementary">
                                                            ...
                                                            <section id="block-menu-block-3" class="block block-menu-block clearfix">
                                                             ...
                                                             <ul class="menu nav">
                                                            <li class="first leaf  menu-mlid-1154"><a href="http://keck.ac.in/department/civil/rm" class="sf-depth-2 active">Rashid Mustafa</a></li>
                                                            ...
                                                            <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/civil/sss" class="sf-depth-2">Shanhank shekhar sandilya</a></li>
                                                               </ul></div>
                                                            </section>
                                                              </div>
                                                    </aside>
            ...
            <c:forEach var="item" items="${Role}">
                                    <c:if test = "${'Faculty' eq item and UserName eq 'shashank'}">
...
<c:forEach var="item" items="${Role}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="sss" id="profileImage"
                    style="height: 200px;width:250px"src="http://keck.ac.in/${facultyId}/image${fileExtension}"/>
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp;&nbspRiver morphology,computation of canal seepage</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
