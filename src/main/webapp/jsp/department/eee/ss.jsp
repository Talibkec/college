...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Saket Saurabh(Faculty)</h3></div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage" src="ss.JPG"
                                                                                   style="background-image: url(ss.JPG);"/>
                        <h2>Saket Saurabh</h2>
                        <p style="font-size: 130%;">Assistant Professor<br/> Department of Electrical and Electronics
                            Engineering</p>
                        <p><i class="fa fa-phone"></i>7004712309 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto: saket.srb@gmail.com"> <span> saket.srb@gmail.com</span>
                        </a></p> <br/><br/>
                        ...
                        <div class="panel panel-default facultyInfo">
                            <div class="panel-heading"><Strong>&nbsp4Years of Teaching Experiences</Strong></div>
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp &nbsp1.TEQIP Co-ordinator </td>
                                </tr>
                                <tr>
                                    <td>&nbsp &nbsp2.Professor In-Charge of Student Attendance </td>
                                </tr>
                                </tbody>
                            </table>
                        </div></div>
