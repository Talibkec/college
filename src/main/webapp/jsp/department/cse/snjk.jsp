                                ...
                                <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                                    ...
                                    <div class="panel panel-default facultyInfo">
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                <tr>
                                                    <td>1.&nbspDeep Learning </td>
                                                </tr>
                                                <tr>
                                                    <td>2.&nbspArtificial Intelligence </td>
                                                </tr>
                                                <tr>
                                                    <td>3.&nbspInternet of Things </td>
                                                </tr>
                                    ...
                                    <div class="panel panel-default facultyInfo">
                                        <div class="panel-heading"><Strong>Research and Development Activities</Strong>
                                        </div>
                                        <table class="table table-striped">
                                            <tbody>
                                                <tr>
                                    ...
                                    <div class="panel panel-default facultyInfo">
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                <tr>
                                                    <td>6 years experience in top-notch Product Based
                                                        Companies(Samsung,Qualcomm)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div class="">
                                            <c:forEach items="${facultyDocument}" var="facultyDocument">
                                                <div>
                                                    ...
                                                    <c:forEach var="item" items="${Role}">
                                                        <c:if
                                                            test="${'Faculty' eq item and UserName eq 'sinjan.kumar' }">
