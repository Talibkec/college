...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Shweta Kumari(Faculty)</h3></div>
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                                                                                   src="Shwetakumari.JPG"
                                                                                   style="background-image: url(Shwetakumari.JPG);"/>
                        <h2>Shweta Kumari</h2>
                        <p style="font-size: 130%;">Assistant Professor<br/> Department of Computer Science and
                            Engineering</p>
                        <p><i class="fa fa-phone"></i>7549647373 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto:shwetaverma673@gmail.com"> <span> shwetaverma673@gmail.com</span>
                        </a></p> <br/><br/>
