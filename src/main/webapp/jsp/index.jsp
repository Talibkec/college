           ...
           <div  class="flex gap-1" >
            ...
            <c:forEach items="${scrollingNoticeList}" var="scrollingNotice">
             ...
             <c:if test = "${scrollingNotice.noticeAge <= 45}">
                <img class="" src="/sites/noticeicon.gif" alt=" Related image" width="44" height="0" style="display: inline" />
             </c:if>
  ...
  <div id="default-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/${image.imageSlideId}/slideImage${image.fileType}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            <c:forEach var="item" items="${Role}">
                         <c:if test = "${'Admin' eq item}">
    ...
    <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
        ...
        <c:forEach items="${imageList}" var="image">
           ...
           <button type="button" class="w-3 h-3 rounded-full" style="background:#444" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
    ...
    <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
        <span style="background:#777" class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
...
<div class="notice md:flex  justify-around p-4" >
   ...
   <div class="p-5 basis-1/3  border-2 border-grey-800 importantlinks h-[50vh]" style="flex-basis: 33%;">
          ...
          <div class="link">
            ...
            <div class="link">
                &raquo; <a href="http://www.educationbihar.gov.in/login.aspx?ReturnUrl=%2fDefault.aspx">Education Dept. Bihar</a>
            </div>  
            <div class="link">
                &raquo; <a
            ...
            <c:forEach items="${noticeList}" var="notice">
                <c:if test = "${ notice.noticeType == 'News' or notice.noticeType == 'Notice'}">
                   <div>
                       ...
                       <c:forEach var="item" items="${Role}">
                           <c:if test = "${'Admin' eq item}">
                           <span class="bg-red-600 rounded-xl m-1 p-1 text-white"><a href="<c:url value='/auth/delNotice/${notice.id}'/>">Delete</a></span>
                        </c:if>
                       </c:forEach>
                            <style>
                            .underline {
    ...
    <div class="w-full absolute left-0 bottom-0 flex justify-center">
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">View All Notices</button>
    </div>
    ...
    <div class="relative p-5 basis-1/3 tenders border-2 border-grey-800"  style="flex-basis: 33%;">
            ...
            <c:forEach items="${noticeList}" var="notice">
                <c:if test = "${notice.noticeType == 'Tendor'}">
                   <div>
                       ...
                       <c:forEach var="item" items="${Role}">
                           <c:if test = "${'Admin' eq item}">
                           <span class="bg-red p-1 text-white"><a href="<c:url value='/auth/${notice.uploadedFileName}/${notice.id}'/>">Delete</a></span>
                        </c:if>
                       </c:forEach>
        ...
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">View All Tenders</button>
        </div>
    </div>
                                        ...
                                        <div class="views-field views-field-field-image">
                                            <div class="p-5 field-content embed-responsive embed-responsive-16by9">
                                                <iframe frameborder="0" height="200"
                                                   ...
                                                   <div class="flex justify-center">           <a class="box-link" href="/gallery/mediagallery" >View All </a></div>
