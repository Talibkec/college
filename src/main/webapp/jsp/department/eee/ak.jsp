...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Abhijeet Kumar(Faculty)</h3></div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage" src="ak.JPG"
                                                                                   style="background-image: url(ak.JPG);"/>
                        <h2>Abhijeet Kumar</h2>
                        <p style="font-size: 130%;">Assistant Professor<br/> Department of
                            Electrical and Electronics Engineering</p>
                        <p><i class="fa fa-phone"></i>8802927260,6203522859 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto: abhijeet.mnit@gmail.com"> <span> abhijeet.mnit@gmail.com</span>
                        </a></p> <br/><br/>
