<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="" >
            <div class="flex w-full justify-center">
                <div class="text-xl p-2">
                    <h3>About Electronics Engineering (VLSI Design and Technology )</h3>
                </div>
    ...
    <div class="">
        ...
        <div class="md:flex justify-center m-5 p-4 ">
            <jsp:include page="../sidebars/ecesidebar.jsp" />
            <div class="col-md-6 m-5"   style="max-width: 500px;">
                <div class="page-content" style="line-height: 175%; font-size: 125%; font-weight: 300;">
                    <div style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; text-align: justify;">
                        ...
                        <div>
                            ...
                            designs, which is usually known as chip design. It aims to prepare skilled graduates who
                            know the
                            key aspects of VLSI Design which is required in VLSI domain Industries.
                        </div>
                        <div>
                            Through B.Tech. - Electronics Engineering (VLSI Design and Technology) program, graduates
                            will
                            develop an in-depth understanding of semiconductor devices, VLSI circuit design and
                            verification,
                            ...
                            verification of electronics systems and circuits and its applications are found in areas
                            like
            ...
            <div class="heroCol col-sm-3" style="min-width: 200px;">
                    ...
                    <div class="panel-heading">
                        ...
                        <c:forEach var="item" items="${Role}">
                            <c:if test="${'HOD' eq item  and UserName eq 'hodeee'}">
                                ...
                                <strong><i class="fa fa-news"></i> <a href="/hod/uploadfile/upload">Upload Notice /
                                        News</a></strong>
