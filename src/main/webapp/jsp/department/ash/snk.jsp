                     ...
                     style="height: 200px;width:250px"src="http://localhost/${facultyId}/image${fileExtension}"/>
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1. &nbsp &nbspFuture of low cost budget airlines</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
						<div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp &nbsp12 years Experience in marketing field </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
						<div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp &nbspOrganisational Behaviour and Industrial Phscology and Industrial Economics and Physcology </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
