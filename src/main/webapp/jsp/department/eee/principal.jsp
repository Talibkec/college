...
<jsp:include page="/jsp/header.jsp"/>
 <div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Ranjana Kumari</h3></div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage" src="../about-kec/principal1.JPG"
                        ...
                        <p style="font-size: 130%;">Principal<br/> Department of Electrical and Electronics
                            Engineering<br></p>
                        <p><i class="fa fa-phone"></i> 9576977097 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto:principalranjanakri84@gmail.com"> <span> principalranjanakri84@gmail.com</span>
                        </a></p> <br/><br/>
