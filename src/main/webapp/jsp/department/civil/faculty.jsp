                ...
                <div class="page-content"><h2>Faculty Members</h2></div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt="" src="http://keck.ac.in/${faculty.facultyId}/image.${faculty.fileType}"
                                ...
                                <div class="col-sm-3 box-profile-link"><a href="http://keck.ac.in/facultyDetails?facultyId=${faculty.facultyId}"
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3 box-profile-link"><a href="http://keck.ac.in/fecultyDetails?fa"
                                                                          class="btn btn-default btn-lg"> <br
                                        class="hidden-xs"/> <i class="fa fa-link"></i> Visit<br class="hidden-xs"/>
                                    Profile Page </a></div>
                            </div>
