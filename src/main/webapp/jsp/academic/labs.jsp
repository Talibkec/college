...
<div class="jumbotron flex justify-center w-full">
        <div class="">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3 class="text-2xl">List of Labs</h3></div>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <table style="width: 100%; padding: 10px;">
                        ...
                        <c:forEach items="${allDocuments}" var ="document">
                            ...
                            <c:if test="${embedpdf}">
                                ...
                                <div>
                                    <object data="https://drive.google.com/viewerng/viewer?embedded=true&url=https://keck.ac.in/approval/lab/${document.id}" type="application/pdf" width="700" height="1000">
                                        <embed src="https://drive.google.com/viewerng/viewer?embedded=true&url=https://keck.ac.in/approval/lab/${document.id}" type="application/pdf">
                                    </object>
                                </div>
                            ...
                            <tr bgcolor="#e9feea">
                                ...
                                <td align="center">
                                    ...
                                    <a href="/approval/lab/${document.id}">
                                        <button type="button" class="btn btn-success" data-dismiss="modal">Download
                                        </button></a>
                                </td><td>
                                <c:if test="${showDeleteBtn}">
                                    <a href="/approval/deleteLab/${document.id}">
