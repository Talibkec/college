...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Alauddin Ansari(Faculty)</h3></div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage" src="aa.JPG"
                                                                                   style="background-image: url(aa.JPG);"/>
                        <h2>Alauddin Ansari</h2>
                        <p style="font-size: 130%;">Assistant Professor and Library Incharge <br/>Department of
                            Electrical and Electronics Engineering</p>
                        <p><i class="fa fa-phone"></i>9027262492 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto: alauddinansari0432@gmail.com"> <span> alauddinansari0432@gmail.com</span>
