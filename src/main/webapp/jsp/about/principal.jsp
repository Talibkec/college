                ...
                <div class="page-content" style="line-height: 175%; font-size: 125%; font-weight: 300;"><p
                    ...
                    <div style="font-family: Georgia, Helvetica, sans-serif; font-size: 16px; text-align: justify;">
                        <div style="float: left;"><img class=" wp-image-81 alignleft"
                                                       ...
                                                       src="/11/image${fileExtension}"
                                                       alt=""/></div>
                        <div style="padding: 25px; margin-left: 10px;" data-animation="bounceInUp"
                             data-animation-delay="0s">Education comes from within, you get it by struggle, effort and thought.
                            <strong> We cannot always build the future for our students, but we can build our students for the future</strong>
                      At KEC Katihar we would like to focus on grooming young minds as the pillar of advancement of a nation & hope of the future. we believe in humanity, discipline, punctuality, regularity. Words visualize the ambition and our aim is to educate the students to LEARN, not just STUDY.
                            <br>
                            Hard work and discipline are the sure roads towards success. Therefore Our doctrine of student's development is based on three Ds - Determination, Dedication and Discipline so that they can excel in their respective fields. Our main job is not only to get them jobs instead; facilitate them to provide jobs. Ergo we strive to endeavour beyond the boundaries of mere books.</br>
                            So, it's my pleasure to welcome you to KEC Katihar,an institute under department of science and technology, government of Bihar . We ensure that the students prove themselves to be not only well qualified engineers but also very responsible and ideal citizens of our country.</div>
                        <hr/>
                        With Regards,<br/> <strong>Smt. Ranjana Kumari </strong><br/> Email: <a
