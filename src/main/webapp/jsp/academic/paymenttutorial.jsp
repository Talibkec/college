<jsp:include page="/jsp/header.jsp"/>
     <div class="jumbotron flex justify-center w-full">
             <div class="">
                 <div class="row">
                     <div class="col-md-10 col-sm-8"><h3 class="text-2xl">Fee Payment ( Through SBI COLLECT)</h3></div>
                 </div>
             </div>
         </div>
         <div class="container">
...
<br/>
                                                     <div id="ctl00_ContentPlaceHolder1_div_0"><strong>Or you can also download the the pdf which contains the screenshots of the steps as mentioned above for fee payment: </strong>
                                                                                                                                             <a href="/jsp/facilities/payment.pdf" target="_blank">Click here to download</a></div>
