    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <c:forEach var="item" items="${Role}">
                        <c:if test = "${'Faculty' eq item and UserName eq 'sritosh'}">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1.&nbsp&nbspOperating System<br/>2.&nbsp&nbspData Structure<br/>3.&nbsp&nbspSoftware Engineering<br/>4.Computer Architecture </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
