...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Pradeep Kumar Sharma(Faculty)</h3></div>
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                                                                                   src="pks.jpg"
                                                                                   style="background-image: url(pks.jpg);"/>
                        <h2>Pradeep Kumar Sharma</h2>
                        <p style="font-size: 130%;">Assistant Professor <br/> Department of Computer Science and
                            Engineering</p>
                        <p><i class="fa fa-phone"></i> 8876024875 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="/cdn-cgi/l/email-protection#14706667616671677c797d60547379757d783a777b79"> <span>cspradeepindia@gmail.com</span>
                        </a></p> <br/><br/>
