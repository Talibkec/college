    ...
    <div class="container">
        ...
        <aside class="col-sm-3" role="complementary">
                    ...
                    <section id="block-menu-block-3" class="block block-menu-block clearfix">
                     ...
                     <ul class="menu nav">
                    <li class="first leaf  menu-mlid-1154"><a href="http://keck.ac.in/department/cse/about" class="sf-depth-2 active">About CSE</a></li>
                    <li class="leaf menu-mlid-1121"><a href="http://keck.ac.in/department/cse/vision" class="sf-depth-2">Vision & Mission</a></li>
                    <li class="leaf menu-mlid-1156"><a href="http://keck.ac.in/department/cse/faculty" class="sf-depth-2">Faculty of CSE</a></li>
                    <li class="leaf menu-mlid-1294"><a href="http://keck.ac.in/department/cse/labs" class="sf-depth-2">Labs & Infrastructure</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/question" class="sf-depth-2">Question Bank</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/awards" class="sf-depth-2">awards & Recognition</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/programs" class="sf-depth-2">Program Activities</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/students" class="sf-depth-2">Student of CSE</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/notice" class="sf-depth-2">Notice</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/weekly" class="sf-depth-2">Weekly Test Result</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/programs" class="sf-depth-2">Course File</a></li>
                     <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/staff" class="sf-depth-2">Staff of CSE</a></li>
                    <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/cse/attendance" class="sf-depth-2">Attendance Summary</a></li>
                       </ul></div>
                ...
                <div class="page-content"><h2>Faculty Members</h2>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt="" src="http://keck.ac.in/3/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/3/image${fileExtension})"/>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt="" src="http://keck.ac.in/2/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/dky.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/4/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/Shwetakumari.JPG)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/5/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/snehakumari.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/6/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/sjk.JPG)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/1/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/mta.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/7/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/pks.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/9/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/sjn.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3 box-profile-image"><img alt=""
                                                                             src="http://keck.ac.in/10/image${fileExtension}"
                                                                             style="background-image: url(http://keck.ac.in/department/cse/shk.jpg)"/>
                                    <div class="visible-xs"><br/></div>
                                </div>
                                <div class="col-sm-6 box-profile-info"><strong>Department:</strong> Department of
                                    Computer Science and Engineering<br/> <strong>Designation:</strong> Assistant
                                ...
                                <div class="col-sm-3 box-profile-link"><a href="http://keck.ac.in/department/cse/shk"
                                                                          class="btn btn-default btn-lg"> <br
                                        class="hidden-xs"/> <i class="fa fa-link"></i> Visit<br class="hidden-xs"/>
                                    Profile Page </a></div>
                            </div>
