...
<div class="container"> <br /><br /><div class="row"><div class="col-sm-offset-4 col-sm-4">
    <div class="panel panel-default"><div class="panel-heading"> <i class="fa fa-sign-in"></i>Upload Responsibility Doc</div>
...
<script src="/js/uploadResponsibilityDoc.js"></script>
