    ...
    <div class="container">
        ...
        <div class="row">
            <aside class="col-sm-3" role="complementary">
                                                ...
                                                <li class="leaf menu-mlid-1467"><a href="http://keck.ac.in/department/civil/sss" class="sf-depth-2">Shashank shekhar sandilya
                                                 </ul></div>
                                                </section>
                                                  </div>
                                        </aside>
            ...
            <c:forEach var="item" items="${Role}">
                                    <c:if test = "${'Faculty' eq item and UserName eq 'aale'}">
...
<c:forEach var="item" items="${Role}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="ar" id="profileImage"
                    style="height: 200px;width:250px" src="http://keck.ac.in/${facultyId}/image${fileExtension}"/>
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp;&nbspSlope stability using soft computing</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
