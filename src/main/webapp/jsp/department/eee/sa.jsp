        ...
        <div class="row">
           ...
           <div class="col-md-8">
            <c:forEach var="item" items="${Role}">
                                    <c:if test = "${'Faculty' eq item and UserName eq 'sajjad.ahmad'}">
              ...
              style="height: 200px;width:250px"src="http://keck.ac.in/${facultyId}/image${fileExtension}"/>
                        ...
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp&nbspPh.D (Pursuing from Jamia Millia Islamia Central University New Delhi)</td>
                                </tr>
								<tr>
									<td>&nbsp&nbspM.Tech(Jamia Millia Islamia Central University New Delhi)</td>
								</tr>
								<tr>
									<td>&nbsp&nbspB.Tech(BCE Bhagalpur)</td>
								</tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1.&nbsp&nbspOptimization of Solar Energy System by using Intelligent Techniques</td>
                                </tr>
								<tr>
									<td>2.&nbsp&nbspRenewable Energy</td>
								<tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>&nbsp&nbspPurchase Officer</td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>1.&nbsp&nbspBasic Electronics</td>
                                </tr>
								<tr>
                                    <td>2.&nbsp&nbspDigital Electronics</td>
                                </tr>
								<tr>
                                    <td>3.&nbsp&nbspControl System</td>
                                </tr>
