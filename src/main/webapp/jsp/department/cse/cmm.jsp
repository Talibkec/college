...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Dr. CM Mandal(Faculty)</h3></div>
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                                                                                   src="cmm.JPG"
                                                                                   style="background-image: url(cmm.JPG);"/>
                        <h2>Dr. CM Mandal</h2>
                        <p style="font-size: 130%;">Assistant Professor<br/> Department of Computer Science and
                            Engineering<br/><p> <i class="fa fa-phone"></i> 9430694843 &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="/cdn-cgi/l/email-protection#14706667616671677c797d60547379757d783a777b79">
                            <span>chintamanimandal@gmail.com.com</span>
                        </a>
                        </p>
                        <br/><br/>
