...
<div class="container mx-auto my-12">
    <div class="text-center mb-8">
        <h2 class="text-2xl font-semibold text-gray-800"><i class="fa fa-sign-in"></i> Upload Downloadable Resource</h2>
    </div>
        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
            <form method="POST" enctype="multipart/form-data" id="slideimageUploadForm" class="space-y-6">
                <div class="flex flex-col">
                    <label for="caption" class="text-gray-700 font-medium mb-2">Enter Title of File</label>
