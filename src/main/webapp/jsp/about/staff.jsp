        ...
        <div class="col-md-8">
            ...
            <c:forEach items="${staffList}" var="staff">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading faculty-title"><b> ${staff.staffName} </b>
                    </div>
                    <div class="panel-body">
                        <div class="row" style="display:block ">
                          ...
                          <div class="col-sm-6">
                              ...
                              <strong>Phone
                                    Number:</strong>${staff.staffMobNo}<br/>
                              <strong>Email
                                    Address:</strong> <a
                                        href="mailto:${staff.staffOfficialEmail}">${staff.staffOfficialEmail}</a>
                                <div class="visible-xs"><br/></div>
                          </div>
                            <div class="col-sm-3 box-profile-link"><a
                                    href="/staffDetails?staffId=${staff.staffId}"
