...
<head>
    ...
    <style>
@import url("http://localhost/modules/system/system.base.css");

    </style>
    <style>
@import url("http://localhost/sites/all/modules/contrib/views_slideshow/views_slideshow.css");

    </style>
    <style>
@import url("http://localhost/sites/all/modules/date/date_api/date.css");
@import url("http://localhost/sites/all/modules/date/date_popup/themes/datepicker.1.7.css");
@import url("http://localhost/modules/field/theme/field.css");
@import url("http://localhost/modules/node/node.css");
@import url("http://localhost/sites/all/modules/contrib/views/css/views.css");
@import url("http://localhost/sites/all/modules/contrib/ckeditor/css/ckeditor.css");

    </style>
    <style>
@import url("http://localhost/sites/all/modules/contrib/ctools/css/ctools.css");
@import url("http://localhost/sites/all/modules/lightbox2/css/lightbox.css");
@import url("http://localhost/sites/all/modules/contrib/views_slideshow/views_slideshow_controls_text.css");
@import url("http://localhost/sites/all/modules/contrib/views_slideshow/contrib/views_slideshow_cycle/views_slideshow_cycle.css");
@import url("http://localhost/sites/all/modules/contrib/jcarousel/skins/default/jcarousel-default.css");
...
@import url("http://localhost/sites/all/themes/bootstrap/css/3.3.5/overrides.min.css");
@import url("http://localhost/sites/all/themes/rwsiitj/css/style.css");
@import url("http://localhost/sites/all/themes/rwsiitj/js/jqueryui/jquery-ui.min.css");
...
<link href="http://localhost/wp-content/themes/kec/assets/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" />
<link href="http://localhost/wp-content/themes/kec/assets/vendors/bootstrap/dist/css/bootstrap-theme.css" rel="stylesheet" />
<link href="http://localhost/wp-content/themes/kec/assets/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css">
<link href="http://localhost/wp-content/themes/kec/assets/css/editor.css" rel="stylesheet" />
<link href="http://localhost/wp-content/themes/kec/assets/css/common.css" rel="stylesheet" />
<link id="theme" href="http://localhost/wp-content/themes/kec/assets/css/default.css" rel="stylesheet" />
<link href="http://localhost/wp-content/themes/kec/assets/vendors/bootstrap-sweetalert/dist/sweetalert.css" rel="stylesheet" />
...
<script src="http://localhost/wp-content/themes/kec/assets/vendors/waypoints/lib/shortcuts/sticky.min.js"></script>
<script src="http://localhost/wp-content/themes/kec/assets/vendors/nivo-lightbox/dist/nivo-lightbox.min.js"></script>
    ...
    <script src="http://localhost/sites/all/modules/contrib/views_slideshow/js/views_slideshow.js?v=1.0"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.js"></script>
    <script src="http://localhost/sites/all/modules/lightbox2/js/lightbox.js"></script>
    ...
    <script src="http://localhost/sites/all/libraries/jquery.cycle/jquery.cycle.all.js"></script>
    <script src="http://localhost/sites/all/modules/contrib/views_slideshow/contrib/views_slideshow_cycle/js/views_slideshow_cycle.js"></script>
    <script src="http://localhost/sites/all/modules/contrib/jcarousel/js/jcarousel.js"></script>
    <script src="http://localhost/sites/all/modules/contrib/jcarousel/js/jquery.jcarousel.min.js"></script>
    <script src="http://localhost/sites/all/libraries/superfish/jquery.hoverIntent.minified.js"></script>
    ...
    <script src="http://localhost/sites/all/themes/rwsiitj/js/jquery.easy-ticker.js"></script>
    <script src="http://localhost/sites/all/themes/rwsiitj/js/jquery.marquee.min.js"></script>
                            ...
                            <li id="menu-1124-1"
                                ...
                                <ul>
                                    ...
                                    <li id="menu-1411-1" class="middle even sf-item-2 sf-depth-2 sf-no-children"><a
                                            href="https://localhost:2096/webmail" class="sf-depth-2">Mail Login</a></li>
