                    ...
                    <table style="width: 100%; padding: 10px;">
                        ...
                        <c:forEach items="${allDocuments}" var ="document">
                            ...
                            <c:if test="${embedpdf}">
                                ...
                                <div>
                                    <object data="https://drive.google.com/viewerng/viewer?embedded=true&url=http://keck.ac.in/approval/lab/${document.id}" type="application/pdf" width="700" height="1000">
                                        <embed src="https://drive.google.com/viewerng/viewer?embedded=true&url=http://keck.ac.in/approval/lab/${document.id}" type="application/pdf">
                                    </object>
                                </div>
