           ...
           <aside class="col-sm-3" role="complementary">
                ...
                <div class="col-md-8">
                 <c:forEach var="item" items="${Role}">
                                        <c:if test = "${'Faculty' eq item and UserName eq 'jayant906'}">
                        ...
                        style="height: 200px;width:250px"src="http://keck.ac.in/${facultyId}/image${fileExtension}"/>
                            ...
                            <div class="panel panel-default facultyInfo">
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td>Ph.D (Pursuing IIT Roorkee)</td>
                                    </tr>
									<tr>
									<td>M.Tech(IIT Delhi)</td>
									</tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="panel panel-default facultyInfo">
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td>&nbsp&nbspComposite materials & Advance manufacturing process </td>
                                    </tr>
                            ...
                            <div class="panel panel-default facultyInfo">
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td>&nbsp&nbspAcademic In-Charge</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div></div>
