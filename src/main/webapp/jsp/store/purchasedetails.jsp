...
<div class="container" style="margin:50px">
        ...
        <div class="row" style="border:1px solid green;padding:10px">
            ...
            <div class="col-md-2 text-center"><strong>Invoice</strong></div>
            <div class="col-md-2 text-center"><strong>Edit Purchase</strong></div>
        </div>
         <c:forEach items="${purchases}" var="element">
            <div class="row" style="border:1px solid green;padding:10px">
            <div class="col-md-2 text-center">${element.quantity}</div>
            ...
            <div class="col-md-2 text-center">${element.invoice}</div>
