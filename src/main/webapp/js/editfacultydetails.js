$(document).ready(function () {
    ...
    var fieldHTML = '<div class="newpropkeybox panel panel-success">' +
        ...
        '<a href="javascript:void(0);" class="remove_button btn btn-danger"style="width:9.5%;margin-left:1%;margin-top:2%;margin-left:0.5%"><span class="glyphicon glyphicon-remove-sign">delete</span></a></div></div>';
    ...
    $(wrapper).on('click', '.add_button', function (e) {
        ...
        $(this).parent('div').last().after('<div class="propVals"><input type="text"placeholder="Property Value" name="field_name" value=""style="margin-left:3%;margin-top:2%" class="propVal control-label col-md-6"/>' +
            ...
            '<a href="javascript:void(0);" class="remove_button btn btn-danger "style="width:9%;margin-top:2%;margin-left:0.5%"><span class="glyphicon glyphicon-remove-sign">delete</span></a>'); //Remove field html
    ...
    $(".oldPropsClass").on('click', '.add_button', function (e) {
        ...
        $(this).parent('div').last().after('<div class="propVals"><input type="text" style="margin-left:3% " name="field_name" value="" class="propVal col-md-6"/>' +
            ...
            '<a href="javascript:void(0);" class="remove_button btn btn-danger mt-5 w-full " ><span class=" "><i class="fa-solid fa-trash fa"></i></span></a>'); //Remove field html
        x--; //Decrement field counter
    });
