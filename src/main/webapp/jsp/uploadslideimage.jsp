...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
      ...
      <form method="POST" enctype="multipart/form-data" id="slideimageUploadForm" action="/" class="space-y-6">
          ...
          <div>
              <label for="flag" class="block text-sm font-medium text-gray-700">Select View</label>
              <select name="flag" id="flag" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
