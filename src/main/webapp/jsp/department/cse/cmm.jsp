    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <c:forEach var="item" items="${Role}">
                        <c:if test = "${'Faculty' eq item and UserName eq 'chintamani'}">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="profile"><img alt="" id="profileImage"
                      ...
                      <h2>${facultyName}</h2>
                        <p style="font-size: 130%;">Assistant Professor<br/> Department of Computer Science and
                            Engineering<br/><p> <i class="fa fa-phone"></i> ${facultyMobNo} &nbsp; | &nbsp; <i class="fa fa-envelope"></i> <a
                                href="mailto:${facultyOfficialEmail}"> <span>${facultyOfficialEmail}</span> |<i class="fa fa-envelope"></i> <a
                                                                                                                                             href="mailtp:${facultyPersonalEmail}"> <span>${facultyPersonalEmail}</span>
                        </a>
                        </p>
                        <br/><br/>
						...
						<div class="panel panel-default facultyInfo">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                <tr>
                                    <td>20 years of Teaching Experience.						</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
