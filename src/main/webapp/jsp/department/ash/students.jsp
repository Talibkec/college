...
<div class="jumbotron" style="padding-top: 24px; padding-bottom: 24px;">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-8"><h3>Students of Applied Science and Humanities</h3></div>
        ...
        <div class="row">
            <div class="col-md-4">
                <ul class="list-group page-menu">
                                    ...
                                    <li class="list-group-item"><a href="http://localhost/department/ash/about">&nbsp;&nbsp; <i
